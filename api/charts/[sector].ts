// Returns chart arrays for each sector id matching the legacy Express server outputs.
        ...
        charts = [
          {
            ...
            data: {
              ...
              datasets: [
                {
                  label: 'Literacy Rate (%)',
                  data: [93.91, 91.58, 87.75, 87.4, 83.78, 82.91, 82.2, 80.33, 79.63, 76.68],
              ...
              datasets: [
                {
                  ...
                  data: [34.83, 37.7, 41.87, 45.03, 47.66],
                  backgroundColor: 'rgba(239, 68, 68, 0.2)',
                  borderColor: 'rgba(239, 68, 68, 1)',
                  borderWidth: 2,
                  fill: false,
